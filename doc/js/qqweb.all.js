...
var l=b.id("verify_img_code"),m=b.id("verify_a_code"),o=b.id("verify_input_code"),v=null;
a.on(l,"load",
	function(){v=f.cookie.get("verifysession",EQQ.CONST.MAIN_DOMAIN)});
a.on(m,"click",
	function(z){z.preventDefault();b.id("verify_img_code").src="http://captcha.qq.com/getimage?aid=1003901&"+Math.random()});

a.addObserver(t,"clickOkButton",function(){var z=o.value;z&&v&&e(j,z,v)});
o.focus();
a.on(o,"keydown",
function(z){z.keyCode==13&&a.notifyObservers(t,"clickOkButton")&&setTimeout(
function(){t.close()},0)});
